...
int main(int argc, char **argv)
{
  ...
  Runtime::register_legion_task<compute_launcher_helper_task>(COMPUTE_LAUNCHER_HELPER_TASK_ID,
      Processor::LOC_PROC, true/*single*/, false/*index*/, AUTO_GENERATE_ID, TaskConfigOptions(false,true,false), "compute_launcher_helper_task");
