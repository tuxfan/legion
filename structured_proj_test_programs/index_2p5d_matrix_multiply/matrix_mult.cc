...
class LeftMatrixProjectionFunctor : public ProjectionFunctor
{
  public:
    LeftMatrixProjectionFunctor(int k_coeff, int mod_by)
      : ProjectionFunctor(), k_coeff(k_coeff), mod_by(mod_by) {}
    ...
    virtual LogicalRegion project(Context ctx, Task *task, unsigned index,
                                  ...
                                  const DomainPoint &point)
    {
      Point<3> point_in_matrix;
      point_in_matrix[0] = point[0];
      point_in_matrix[1] = real_mod(point[0] + point[1] - k_coeff * point[2] - point[3], mod_by);
      point_in_matrix[2] = point[2];
...
class RightMatrixProjectionFunctor : public ProjectionFunctor
{
  public:
    ...
    {
      Point<3> point_in_matrix;
      point_in_matrix[0] = real_mod(point[0] + point[1] - k_coeff * point[2] - point[3], mod_by);
      point_in_matrix[1] = point[1];
      point_in_matrix[2] = point[2];
...
class ProductMatrixProjectionFunctor : public ProjectionFunctor
{
  public:
