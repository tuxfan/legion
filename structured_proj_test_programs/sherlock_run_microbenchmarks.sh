...
do
  ...
  do
    ...
    do
      affine_command="srun -n $nodes --tasks-per-node 1 --cpu_bind none ./x_parallel_only/runtime_stress_test -i $ITERATIONS -nx $dim -bx $dim -ny $dim -by $dim -sms $sleep_us -sm -ssl 4 -a 225 -ll:cpu 4 -ll:util 1"
